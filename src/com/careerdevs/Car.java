...
// Car Class Constructor
    ...
    sensitive data from users in order to access and update the private variable.
    Setter updates the value of a variable
    Getters read the value of a variable
    **Accessing variables outside a class wothout getters/setters, we have to mark those as public, protected, or default.
    Essentially losing
     */
